        ...
        <div class="terms-signature-grid">
          ...
          <div class="terms-card">
            ...
            <ul class="terms-list">
              ...
              <li>${isEs ? 'No se ha realizado ningún cobro por adelantado en el sistema web. Todo pago se coordina directamente con Brian Cueva al confirmar la cita o al completar el trabajo.' : 'No advance payment has been charged online. All payments are coordinated directly with Brian Cueva upon schedule confirmation or project completion.'}</li>
